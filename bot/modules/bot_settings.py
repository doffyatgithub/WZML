...
default_values = {'AUTO_DELETE_MESSAGE_DURATION': 60,
                  ...
                  'UPSTREAM_REPO': 'https://github.com/doffyatgithub/WZML',
                  'STATUS_UPDATE_INTERVAL': 10,
                  'DOWNLOAD_DIR': '/usr/src/app/downloads/',
                  'TIME_GAP': -1,
                  'TG_SPLIT_SIZE': tgBotMaxFileSize,
                  'TGH_THUMB': 'https://telegra.ph/file/eeb3c20a48b3ff4db3c9f.jpg',
                  'START_BTN1_NAME': 'Shut Up!',
                  'START_BTN1_URL': 'https://donquixotedofuramingo.t.me',
                  'START_BTN2_NAME': '',
                  'START_BTN2_URL': '',
                  'AUTHOR_NAME': 'Mixue x MLTB',
                  'AUTHOR_URL': 'https://mixuemltbot.t.me',
                  'TITLE_NAME': 'Mixuemltbot',
                  'GD_INFO': 'Uploaded by Mixue x MLTB',
                  'CREDIT_NAME': 'Mixuemltbot@tg',
                  'NAME_FONT': 'code',
                  'CAPTION_FONT': 'code',
